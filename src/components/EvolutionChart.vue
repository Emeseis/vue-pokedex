...
export default {
  ...
  methods: {    
    ...
    myTree(domEl, x) {
      ...
      OrgChart.templates.customTemplate.size = [144, 244];
      ...
      `<text class="name-anchor" x="72" y="207">{val}</text>`;
      OrgChart.templates.customTemplate.field_2 = '{val}'
      OrgChart.templates.customTemplate.link_field_0 = 
      '<g class="arrow-text"><text x="0" y="40">({val})</text></g>';
      OrgChart.templates.customTemplate.img_0 = 
      '<image xlink:href="{val}" x="0" y="25" width="144" height="144"/>';
